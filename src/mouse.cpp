...
void Mouse::update() {
    ...
    const MouseData pointer_data = _engine.win->get_pointer(0);
    ...
    _mx = _engine.mouse_watcher->get_mouse_x();
    _my = _engine.mouse_watcher->get_mouse_y();
